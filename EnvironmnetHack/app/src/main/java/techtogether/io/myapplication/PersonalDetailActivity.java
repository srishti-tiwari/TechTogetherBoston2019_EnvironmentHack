       ...
       // String email = getIntent().getExtras().getString(MainActivity.EMAIL);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mRootRef = FirebaseDatabase.getInstance().getReference().child("ecotrackr");

                String id = mRootRef.child("ecotrackr").push().getKey();
                ...
                mRootRef.child("ecotrackr").child("users").child(id).setValue(user);
            }
        });
